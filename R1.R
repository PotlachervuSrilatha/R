...
# It is used for statistical analysis, graphical representation,data analysis & visualization 
# R is a simple and easy to learn,read & write
# It Developed by Ross Ihaka & Robert Gentleman at the University of 
# Auckland, Newzealand
# R is case sensitive 
...
var1 <- c('Srilatha', 9146799, 'address', 40)
class(var1)
var1[c(1,3)]
var1[1:3]
var1[1:4]
...
i[3:6,2]
j1 <- matrix(c("R", "Programming", "Session"), nrow =2, ncol=3 )
...
j[2,3,4] # 2nd row, 5th column, 4th array 
...
m <- data.frame(gender = c("Male", "Male","Female"), height = c(152, 171.5,100), 
                weight = c(81,93,67), Age = c(42,38, 70))
class(m)
m
